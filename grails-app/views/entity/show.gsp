...
<html>
    ...
    <body>
        ...
        <div id="show-entity" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.entity}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.entity}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
